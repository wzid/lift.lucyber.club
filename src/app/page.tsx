  ...
  return (
   <main className="w-full flex flex-col mt-[5rem]">
    <div className="flex flex-col justify-center items-center text-center">
        <h1 className="text-4xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-br from-green-300 to-blue-600">Record your lifts</h1>
        <h2 className="text-3xl md:text-4xl">Increase your <span className="text-[#ff6f6f]">cyber</span> skill</h2>
